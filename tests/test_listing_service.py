...
class TestListingServiceCreateListing:
    def test_create_listing_returns_saved_listing(self, temp_listing_service, temp_item_repo):
    ...
    def test_create_listing_marks_item_as_listed(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="Sword", value=50.0))
    ...
    def test_create_listing_auto_increments_ids(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="A", value=10.0))
        temp_item_repo.save_item(Item(owner_id=1, item_id=2, rarity="epic", item_name="B", value=20.0))
...
class TestListingServiceOwnershipValidation:
    ...
    def test_price_must_be_greater_than_zero(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="Sword", value=50.0))
...
class TestListingServiceCancelListing:
    def test_cancel_listing_deactivates_listing(self, temp_listing_service, temp_item_repo, temp_listing_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="Sword", value=50.0))
        temp_listing_service.create_listing(item_id=1, seller_id=1, price=75.0)
    ...
    def test_cancel_listing_unmarks_item_as_listed(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="Sword", value=50.0))
        temp_listing_service.create_listing(item_id=1, seller_id=1, price=75.0)
        temp_listing_service.cancel_listing(1)
        item = temp_item_repo.get_item_by_id(1)
    ...
    def test_item_can_be_relisted_after_cancel(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="Sword", value=50.0))
        temp_listing_service.create_listing(item_id=1, seller_id=1, price=75.0)
        temp_listing_service.cancel_listing(1)
        relisted = temp_listing_service.create_listing(item_id=1, seller_id=1, price=80.0)
        assert relisted["listing_id"] == 2


class TestListingServiceQueries:
    def test_get_active_listings_excludes_cancelled(self, temp_listing_service, temp_item_repo):
        temp_item_repo.save_item(Item(owner_id=1, item_id=1, rarity="rare", item_name="A", value=10.0))
        temp_item_repo.save_item(Item(owner_id=1, item_id=2, rarity="epic", item_name="B", value=20.0))
        temp_listing_service.create_listing(item_id=1, seller_id=1, price=50.0)
